...
<body>
    <form action="compost/storecompost.php" class="w3-container w3-card-4 w3-light-grey w3-text-blue w3-margin" method="POST" enctype="multipart/form-data">
        ...
        <div class="w3-row w3-section">
            ...
            <div class="w3-rest">
                <input class="w3-input w3-border" name="compostname" type="text" placeholder="ชื่อปุ๋ย" required>
            </div>
        </div>
        ...
        <div class="w3-row w3-section">
            ...
            <div class="w3-rest">
                <input class="w3-input w3-border" name="compostprice" type="text" placeholder="ราคาปุ๋ย" required>
            </div>
        </div>
