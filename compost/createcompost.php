...
<body>
    <form action="compost/storecompost.php" class="w3-container w3-card-4 w3-light-grey w3-text-blue w3-margin" method="POST" enctype="multipart/form-data">
        <div align="center">
            <h2>เพิ่มข้อมูลปุ๋ย</h2>
        </div>
        ...
        <div class="w3-row w3-section">
            ...
            <div class="w3-rest">
                ...
                <img id="showimg" src="upload/<?php echo $image; ?>" style="height:270px; width:200px;">
            </div>
        </div>
        ...
        <div class="w3-row w3-section">
            ...
            <div class="w3-rest">
                <input class="w3-input w3-border" name="productname" type="text" placeholder="ชื่อปุ๋ย" required>
            </div>
        </div>
        ...
        <div class="w3-row w3-section">
            ...
            <div class="w3-rest">
                <input class="w3-input w3-border" name="compostdetail" type="text" placeholder="รายละเอียดปุ๋ย" required>
            </div>
        </div>
        ...
        <div class="w3-row w3-section">
            ...
            <div class="w3-rest">
                <input class="w3-input w3-border" name="productprice" type="text" placeholder="ราคาปุ๋ย" required>
            </div>
        </div>
