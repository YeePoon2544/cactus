...
<body>
    <br>
    <h2 align='center'>ข้อมูลปุ๋ย</h2>
    <a href="admin.php?Menu=3&Submenu=createcompost"><button type="button" class="btn btn-primary">เพิ่มข้อมูล <i class='fas fa-plus-circle' style='font-size:20px'></i></button></a> <br>

</body>

<table class="table table-bordered" align="center" width=65% border=1 cellpadding=4>
    <tr align="center">
        <th>รหัสสินค้าปุ๋ย</th>
        <th>รูปภาพปุ๋ย</th>
        <th>ชื่อปุ๋ย</th>
        <th>รายละเอียดปุ๋ย</th>
        <th>ราคาปุ๋ย</th>
        <th>Edit</th>
        <th>Delete</th>
    </tr>
