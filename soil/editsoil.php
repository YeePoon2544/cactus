...
<body>
    <form action="soil/updatesoil.php?ID=<?php echo $row['soil_ID']; ?>" class="w3-container w3-card-4 w3-light-grey w3-text-blue w3-margin" method="POST" enctype="multipart/form-data">
        ...
        <div class="w3-row w3-section">
            ...
            <div class="w3-rest">
                <input class="w3-input w3-border" name="soilname" type="text" placeholder="ชื่อแคคตัส" value="<?php echo $row['soilname']; ?>">
            </div>
        </div>
        ...
        <div class="w3-row w3-section">
            ...
            <div class="w3-rest">
                <input class="w3-input w3-border" name="soilprice" type="text" placeholder="ราคาแคคตัส" value="<?php echo $row['soilprice']; ?>">
            </div>
        </div>
