...
<body>
    <form action="soil/storesoil.php" class="w3-container w3-card-4 w3-light-grey w3-text-blue w3-margin" method="POST" enctype="multipart/form-data">
        <div align="center">
            <h2>เพิ่มข้อมูลดิน</h2>
        </div>
        <h5>ไฟล์รูปภาพดิน</h5>
        ...
        <div class="w3-row w3-section">
            ...
            <div class="w3-rest">
                <input class="w3-input w3-border" name="soildetail" type="text" placeholder="รายละเอียดดิน" required>
            </div>
        </div>
