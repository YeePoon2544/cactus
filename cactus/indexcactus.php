...
<body>
    <br>
    <h2 align='center'>ข้อมูลแคคตัส</h2>
    <a href="admin.php?Menu=1&Submenu=ceratecactus"><button type="button" class="btn btn-primary"> เพิ่มข้อมูล <i class='fas fa-plus-circle' style='font-size:20px'></i></button></a> <br>
...
<table class="table table-bordered" align="center" width=65% border=1 cellpadding=4>
    <tr align="center">
        <th>รหัสสินค้าแคคตัส</th>
        <th>รูปภาพแคคตัส</th>
        <th>ชื่อแคคตัส</th>
        <th>รายละเอียดแคคตัส</th>
        <th>จำนวนสินค้า</th>
        <th>ราคาแคคตัส</th>
        <th>Edit</th>
        <th>Delete</th>
