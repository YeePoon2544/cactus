...
<?php
    ...
    $Cactus_ID= $_GET['ID'];
    $sql = "SELECT * FROM  cactus WHERE  Cactus_ID='$Cactus_ID' ";
...
<body>
    ...
    <form action="cactus/updatecactus.php?ID=<?php echo $row['Cactus_ID']; ?>" class="w3-container w3-card-4 w3-light-grey w3-text-blue w3-margin" method="POST" enctype="multipart/form-data">
        <div align="center">
            <h2>แก้ไขข้อมูลแคคตัส</h2>
        </div>
        ...
        <div class="w3-row w3-section">
            ...
            <div class="w3-rest">
                <input class="w3-input w3-border" name="Cactusname" type="text" placeholder="ชื่อแคคตัส" value="<?php echo $row['Cactusname']; ?>">
            </div>
        </div>
        ...
        <div class="w3-row w3-section">
            ...
            <div class="w3-rest">
                <input class="w3-input w3-border" name="Cactusdetail" type="text" placeholder="รายละเอียดแคคตัส" value="<?php echo $row['Cactusdetail']; ?>">
            </div>
        </div>
        ...
        <div class="w3-row w3-section">
            ...
            <div class="w3-rest">
                <input class="w3-input w3-border" name="Cactusprice" type="text" placeholder="ราคาแคคตัส" value="<?php echo $row['Cactusprice']; ?>">
            </div>
        </div>
